...
"alternate-background-color: rgb(170, 85, 255);")
        ...
        self.resultTextLable = ResultLabel(self.card)
...
"border-color: rgb(0, 0, 0);")
        ...
        self.heartRateLable = ResultLabel(self.ecg)
        self.heartRateLable.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-color: rgb(0, 0, 0);")
        self.heartRateLable.setFrameShape(QtWidgets.QFrame.Box)
        self.heartRateLable.setObjectName("heartRateLable")
        self.horizontalLayout.addWidget(self.heartRateLable)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.heartRateLable.setText(_translate("MainWindow", "цифры"))
