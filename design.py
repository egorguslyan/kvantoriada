...
"border-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_3.setText(_translate("MainWindow", "Подключить"))
        self.checkBox.setText(_translate("MainWindow", "Подключить"))
        self.checkBox_2.setText(_translate("MainWindow", "Подключить"))
