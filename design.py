...
"")
        ...
        self.analysis = QtWidgets.QPushButton(self.ecg)
        self.analysis.setStyleSheet("background-color:  rgb(225, 194, 36);")
        self.analysis.setObjectName("analysis")
        self.horizontalLayout_3.addWidget(self.analysis)
...
"selection-background-color: rgb(167, 255, 253);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.analysis.setText(_translate("MainWindow", "Анализировать"))
