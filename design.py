...
"border-color: rgb(0, 0, 0);")
        ...
        self.brathAmplitudeLable = QtWidgets.QLabel(self.ecg)
        self.brathAmplitudeLable.setStyleSheet("border-color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);")
        self.brathAmplitudeLable.setFrameShape(QtWidgets.QFrame.Box)
        self.brathAmplitudeLable.setObjectName("brathAmplitudeLable")
        self.gridLayout.addWidget(self.brathAmplitudeLable, 2, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.brathAmplitudeLable.setText(_translate("MainWindow", "цифры"))
