...
"alternate-background-color: rgb(170, 85, 255);")
        ...
        self.ecgFilesCombo.setFocusPolicy(QtCore.Qt.NoFocus)
...
"border-color: rgb(0, 0, 0);")
        ...
        self.eegFilesCombo.setFocusPolicy(QtCore.Qt.NoFocus)
...
"")
        ...
        self.deleteFile_2 = QtWidgets.QPushButton(self.eeg)
        self.deleteFile_2.setStyleSheet("background-color:rgb(229, 62, 62)")
        self.deleteFile_2.setObjectName("deleteFile_2")
        self.horizontalLayout_4.addWidget(self.deleteFile_2)
...
"selection-background-color: rgb(167, 255, 253);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteFile_2.setText(_translate("MainWindow", "Удалить файл"))
